...
export default {
  ...
  [services.backupVaults]: 'azureBackupVaults',
  [services.backupInstances]: 'azureBackupInstances',
  [services.backupPolicies]: 'azureBackupPolicies',
  ...
  [services.recoveryInstances]: 'azureRecoveryInstances',
  [services.recoveryPolicies]: 'azureRecoveryPolicies',
