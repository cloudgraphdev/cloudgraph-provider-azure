...
export default ({
  ...
  const { id, resourceGroupId: rgName, storageAccountId } = service

  /**
   * Find resource group related to this diagnostic setting
   */
  ...
  /**
   * Find storage account related to this diagnostic setting
   */
